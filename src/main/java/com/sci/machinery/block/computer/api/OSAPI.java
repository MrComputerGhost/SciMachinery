...
public class OSAPI {
	...
	public static void registerMethods(Class<?>... clazzes)
		...
		for (Class<?> clazz : clazzes) {
			...
			for (Method method : clazz.getMethods()) {
				...
				if (method.isAnnotationPresent(OSAPIMethod.class)) {
					String main = method.getAnnotation(OSAPIMethod.class)
							.apiMain();
					...
					if (!main.isEmpty()) {
						...
						throw new IllegalArgumentException(
								"You must specifiy a method main for System API Methods");
					}
				}
			}
		}
